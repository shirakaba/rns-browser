...
import { BarAwareWebViewBase, knownFolders, traceEnabled, traceWrite, traceCategories, BarAwareWebViewClient } from "./bar-aware-web-view-common";

export * from "./bar-aware-web-view-common";

let WebViewClient: BarAwareWebViewClient;
...
function initializeWebViewClient(): void {
    ...
    class WebViewClientImpl extends android.webkit.WebViewClient {
        ...
        constructor(public owner: BarAwareWebViewBase) {
            super();
